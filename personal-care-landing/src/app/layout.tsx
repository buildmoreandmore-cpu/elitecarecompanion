...
import { Archivo, Source_Serif_4, Lora, Mulish } from "next/font/google";
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/caregiver-porch.png",
        width: 1200,
        height: 630,
        alt: "A male caregiver helping an older man down his porch steps in metro Atlanta"
      }
    ]
  },
  twitter: {
    ...
    title: "Elite Care for Men — In-Home Care for Older Men | Metro Atlanta",
    description: "Strong, experienced male caregivers for older men in metro Atlanta. Call (470) 696-3850.",
    images: ["/caregiver-porch.png"]
  },
  verification: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${archivo.variable} ${sourceSerif.variable} ${lora.variable} ${mulish.variable} antialiased`}
      >
        {children}
      </body>
    </html>
