...
export const metadata: Metadata = {
  ...
  description: 'Professional home care services in Brookhaven, GA. Serving Town Brookhaven, Emory University area, CDC neighborhoods. 24/7 care, dementia specialists, companion care. Call (470) 840-0575.',
  ...
  twitter: {
    ...
    title: 'In-Home Care for Older Men in Brookhaven | Elite Care Companion',
    description: 'Professional home care in Brookhaven, GA. Care available 24/7. Call (470) 840-0575.',
  }
};
