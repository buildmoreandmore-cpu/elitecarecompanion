...
export const metadata: Metadata = {
  ...
  description: 'Professional home care in historic Druid Hills, GA. Serving Fernbank area, Emory University neighborhoods, Lullwater Park vicinity. Expert care for historic homes and established families. Call (470) 840-0575.',
  ...
  twitter: {
    ...
    title: 'In-Home Care for Older Men in Druid Hills | Elite Care Companion',
    description: 'Professional home care in historic Druid Hills, GA. Compassionate, private-pay care for established families. Call (470) 840-0575.',
  }
};
